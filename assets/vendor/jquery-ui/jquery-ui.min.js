...
!function(e) {
    ...
    l.ui = l.ui || {};
    l.ui.version = "1.13.3";
    var n, t, i, s = 0, o = Array.prototype.hasOwnProperty, h = Array.prototype.slice, a = (l.cleanData = (n = l.cleanData,
    function(e) {
    ...
    l.widget.bridge = function(a, t) {
        ...
        l.fn[a] = function(i) {
            ...
            return e ? this.length || "instance" !== i ? this.each(function() {
                ...
                !1) : t ? "function" != typeof t[i] || "_" === i.charAt(0) ? l.error("no such method '" + i + "' for " + a + " widget instance") : (e = t[i].apply(t, s)) !== t && void 0 !== e ? (n = e && e.jquery ? n.pushStack(e.get()) : e,
    ...
    l.Widget.prototype = {
        ...
        _setOptionClasses: function(e) {
            ...
            for (t in e)
                ...
                e[t] !== this.options.classes[t] && s && s.length && (i = l(s.get()),
        ...
        _on: function(n, a, e) {
            ...
            l.each(e, function(e, t) {
                function i() {
                    if (n || !0 !== h.options.disabled && !l(this).hasClass("ui-state-disabled"))
                        return ("string" == typeof t ? h[t] : t).apply(h, arguments)
                }
    ...
    l.widget,
    l.expr.pseudos || (l.expr.pseudos = l.expr[":"]),
    l.uniqueSort || (l.uniqueSort = l.unique),
    l.escapeSelector || (t = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,
    i = function(e, t) {
    ...
    l.widget("ui.mouse", {
        ...
        _mouseInit: function() {
            ...
            this.element.on("mousedown." + this.widgetName, function(e) {
                ...
                if (!0 === l.data(e.target, t.widgetName + ".preventClickEvent"))
                    return l.removeData(e.target, t.widgetName + ".preventClickEvent"),
        ...
        _mouseDown: function(e) {
            ...
            if (!a)
                ...
                s = !("string" != typeof (t = this).options.cancel || !e.target.nodeName) && l(e.target).closest(this.options.cancel).length,
                ...
                !this._mouseStarted) ? e.preventDefault() : (!0 === l.data(e.target, this.widgetName + ".preventClickEvent") && l.removeData(e.target, this.widgetName + ".preventClickEvent"),
        ...
        _mouseMove: function(e) {
            if (this._mouseMoved) {
                if (l.ui.ie && (!document.documentMode || document.documentMode < 9) && !e.button)
        ...
        _mouseUp: function(e) {
            ...
            e.target === this._mouseDownEvent.target && l.data(e.target, this.widgetName + ".preventClickEvent", !0),
            this._mouseStop(e)),
    ...
    l.widget("ui.slider", l.ui.mouse, {
        ...
        _mouseCapture: function(e) {
            ...
            n.trigger("focus"),
            t = n.offset(),
            o = !l(e.target).parents().addBack().is(".ui-slider-handle"),
            this._clickOffset = o ? {
                left: 0,
                top: 0
            } : {
        ...
        _refreshValue: function() {
            ...
            this._hasMultipleValues() ? this.handles.each(function(e) {
                i = (h.values(e) - h._valueMin()) / (h._valueMax() - h._valueMin()) * 100,
                u["horizontal" === h.orientation ? "left" : "bottom"] = i + "%",
                l(this).stop(1, 1)[r ? "animate" : "css"](u, o.animate),
                !0 === h.options.range && ("horizontal" === h.orientation ? (0 === e && h.range.stop(1, 1)[r ? "animate" : "css"]({
                    left: i + "%"
                }, o.animate),
                1 === e && h.range[r ? "animate" : "css"]({
                    width: i - t + "%"
                }, {
                    queue: !1,
                    duration: o.animate
            ...
            this.handle.stop(1, 1)[r ? "animate" : "css"](u, o.animate),
            "min" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[r ? "animate" : "css"]({
                width: i + "%"
            }, o.animate),
            "max" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[r ? "animate" : "css"]({
                width: 100 - i + "%"
            }, o.animate),
            "min" === a && "vertical" === this.orientation && this.range.stop(1, 1)[r ? "animate" : "css"]({
                height: i + "%"
            }, o.animate),
            "max" === a && "vertical" === this.orientation && this.range.stop(1, 1)[r ? "animate" : "css"]({
                height: 100 - i + "%"
            }, o.animate))
        },
        _handleEvents: {
            keydown: function(e) {
                ...
                case l.ui.keyCode.LEFT:
                    ...
                    this._addClass(l(e.target), null, "ui-state-active"),
                    !1 !== this._start(e, n)))
                        break;
                    return
                }
