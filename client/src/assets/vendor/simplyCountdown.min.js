    ...
    t.simplyCountdown = function(t, o) {
        ...
        var f, h = function(t) {
            ...
            (n = function() {
                ...
                l = new Date,
                w.enableUtc ? (i = new Date(l.getFullYear(),l.getMonth(),l.getDate(),l.getHours(),l.getMinutes(),l.getSeconds()),
                u = (r - i.getTime()) / 1e3) : u = (r - l.getTime()) / 1e3,
                u > 0 ? g() : w.countUp ? (u = (l.getTime() - r) / 1e3,
                g()) : (c = 0,
                d = 0,
                p = 0,
                m = 0,
                ...
                w.onEnd()),
                w.plural ? (t = c > 1 ? w.words.days.plural : w.words.days.singular,
                n = d > 1 ? w.words.hours.plural : w.words.hours.singular,
                e = p > 1 ? w.words.minutes.plural : w.words.minutes.singular,
                y = m > 1 ? w.words.seconds.plural : w.words.seconds.singular) : (t = w.words.days.singular,
                n = w.words.hours.singular,
                e = w.words.minutes.singular,
                y = w.words.seconds.singular),
                w.inline ? o.innerHTML = "".concat(c, " ").concat(t, ", ") + "".concat(d, " ").concat(n, ", ") + "".concat(p, " ").concat(e, ", ") + "".concat(m, " ").concat(y, ".") : (a.days.amount.textContent = (w.zeroPad && c.toString().length < 2 ? "0" : "") + c,
